          ...
          <View style={styles.emptyListContainer}>
            {loading ? (
              ...
              <>
                ...
                />
                <Text style={styles.emptyListText}>No recent reports found.</Text>
                <Text style={styles.emptyListSubText}>Your submitted issues will appear here.</Text>
              </>
            )}
          </View>
        )}
